    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#totaluser").html(data.result.total)
                console.log("userlist",resultData)
...
$(() => {
    ...
    $.ajax({
        ...
        success: function (data) {
            var resultData = data.result.data;
            var sevendays = data.result.aggregations.locationcount.buckets
           
console.log(sevendays)
            var myChart = echarts.init(document.getElementById('main'));
var data = [sevendays[3].avg_scoring.value, sevendays[5].avg_scoring.value, sevendays[2].avg_scoring.value,sevendays[0].avg_scoring.value,sevendays[4].avg_scoring.value,sevendays[1].avg_scoring.value,sevendays[8].avg_scoring.value]
option = {
    color: ['#3398DB'],
    tooltip: {
        trigger: 'axis',
